...
use Alura\Calisthenics\Domain\Email;
...
class Student
{
    ...
    public function __construct(Email\Email $email, DateTimeInterface $bd, string $fName, string $lName, string $street, string $number, string $province, string $city, string $state, string $country)
    {
