...
'RADIUS_LOGIN_IP_HOST' => 'The FormularioLogin-IP-Host attribute. The attribute value is expected to the IP address to connect the user to, encoded as an `integer`, which can be set using `radius_put_addr`.',
'RADIUS_LOGIN_LAT_GROUP' => 'FormularioLogin LAT Group',
'RADIUS_LOGIN_LAT_NODE' => 'FormularioLogin LAT Node',
'RADIUS_LOGIN_LAT_PORT' => 'FormularioLogin LAT Port',
'RADIUS_LOGIN_LAT_SERVICE' => 'FormularioLogin LAT Service',
'RADIUS_LOGIN_SERVICE' => 'The FormularioLogin-Service attribute. The attribute value is an `integer` indicating the service to connect the user to on the login host. The value can be converted to a PHP integer via `radius_cvt_int`.',
'RADIUS_LOGIN_TCP_PORT' => 'The FormularioLogin-TCP-Port attribute. The attribute value is an `integer` indicating the port to connect the user to on the login host. The value can be converted to a PHP integer via `radius_cvt_int`.',
